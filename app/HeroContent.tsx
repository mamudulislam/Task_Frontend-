...
const HeroContent: React.FC = () => {
  return (
    <main
      className="relative z-10 flex items-center min-h-[100vh] w-full bg-cover bg-center"
      style={{ backgroundImage: 'url("/images/girlsface.png")' }}
    >
      <div className="absolute inset-0 bg-black/10 z-0" />

      <Container >
        <div className="flex flex-col md:flex-row justify-between items-end md:items-center min-h-[70vh] gap-[460px] -mb-40">
          <div className="max-w-2xl pt-20 pb-10">
            <h1 className="font-garamond font-bold text-white text-[80px] leading-[92px] tracking-[0%] mb-6">
              Natural Makeup <br /> For Radiant Skin
            </h1>
            <p className="font-garamond font-normal text-white text-[24px] leading-[32px] tracking-[0%] mb-8 max-w-md">
          ...
          <div className="bg-white/90 backdrop-blur-md p-[20px] rounded-[16px] shadow-2xl w-[340px] h-[388px] mt-12 md:mt-0 flex flex-col gap-8">
